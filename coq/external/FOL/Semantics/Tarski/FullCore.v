Require Export PostTheorem.external.FOL.Syntax.Core.
Require Import List.
...
Notation "p ⊫ A" := (forall psi, In psi A -> sat _ p psi) (at level 20).
...
Section Defs.
  ...
  Definition valid_ctx A phi := forall D (I : interp D) rho, (forall psi, In psi A -> rho ⊨ psi) -> rho ⊨ phi.
